...
public class GameActivity extends Activity implements SensorEventListener {
	...
	public static int getResourceID (String inFilename) {
		...
		//
		//if (inFilename.equals("assets/music/kick.wav")) return com.example.myapp.R.raw.assets_music_kick_wav;
		//if (inFilename.equals("assets/music/snare.wav")) return com.example.myapp.R.raw.assets_music_snare_wav;
		//if (inFilename.equals("assets/sounds/Blip_Select1.wav")) return com.example.myapp.R.raw.assets_sounds_blip_select1_wav;
		//if (inFilename.equals("assets/sounds/Blip_Select2.wav")) return com.example.myapp.R.raw.assets_sounds_blip_select2_wav;
		//if (inFilename.equals("assets/sounds/Blip_Select3.wav")) return com.example.myapp.R.raw.assets_sounds_blip_select3_wav;
		//if (inFilename.equals("assets/sounds/Blip_Select4.wav")) return com.example.myapp.R.raw.assets_sounds_blip_select4_wav;
		//if (inFilename.equals("assets/sounds/Laser_Shoot1.wav")) return com.example.myapp.R.raw.assets_sounds_laser_shoot1_wav;
		//if (inFilename.equals("assets/sounds/Laser_Shoot2.wav")) return com.example.myapp.R.raw.assets_sounds_laser_shoot2_wav;
		//if (inFilename.equals("assets/sounds/Laser_Shoot3.wav")) return com.example.myapp.R.raw.assets_sounds_laser_shoot3_wav;
		//if (inFilename.equals("assets/sounds/Laser_Shoot4.wav")) return com.example.myapp.R.raw.assets_sounds_laser_shoot4_wav;
		//if (inFilename.equals("assets/sounds/Pickup_Coin1.wav")) return com.example.myapp.R.raw.assets_sounds_pickup_coin1_wav;
		//if (inFilename.equals("assets/sounds/Pickup_Coin2.wav")) return com.example.myapp.R.raw.assets_sounds_pickup_coin2_wav;
		//if (inFilename.equals("assets/sounds/Pickup_Coin3.wav")) return com.example.myapp.R.raw.assets_sounds_pickup_coin3_wav;
		//if (inFilename.equals("assets/sounds/Pickup_Coin4.wav")) return com.example.myapp.R.raw.assets_sounds_pickup_coin4_wav;
