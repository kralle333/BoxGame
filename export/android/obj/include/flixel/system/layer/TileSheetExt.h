...
class HXCPP_CLASS_ATTRIBUTES  TileSheetExt_obj : public ::openfl::display::Tilesheet_obj{
	...
	public:
		...
		static hx::ObjectPtr< TileSheetExt_obj > __new(::openfl::display::BitmapData bitmap);
		...
		virtual ::String getKey( ::openfl::geom::Rectangle rect,::openfl::geom::Point point);
		Dynamic getKey_dyn();

		virtual int addTileRectID( ::openfl::geom::Rectangle rect,::openfl::geom::Point point);
