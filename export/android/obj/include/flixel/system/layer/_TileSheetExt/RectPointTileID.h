...
class HXCPP_CLASS_ATTRIBUTES  RectPointTileID_obj : public hx::Object{
	public:
		...
		RectPointTileID_obj();
		Void __construct(int id,::openfl::geom::Rectangle rect,::openfl::geom::Point point);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< RectPointTileID_obj > __new(int id,::openfl::geom::Rectangle rect,::openfl::geom::Point point);
