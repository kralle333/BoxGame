...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("BoxGame"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
