...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Date.hx",26,0x51c70a5f)
HX_STACK_THIS(this)
...
::String Date_obj::toString( ){
	HX_STACK_FRAME("Date","toString",0xd2a372cc,"Date.toString","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Date.hx",48,0x51c70a5f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Date.hx",63,0x51c70a5f)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
	{
		HX_STACK_LINE(64)
