...
{
HX_STACK_FRAME("DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",129,0x0780ded5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(129)
	super::__construct();
...
::openfl::display::Stage DocumentClass_obj::get_stage( ){
	HX_STACK_FRAME("DocumentClass","get_stage",0xea357664,"DocumentClass.get_stage","ApplicationMain.hx",155,0x0780ded5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(155)
