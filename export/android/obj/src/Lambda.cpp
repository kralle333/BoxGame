...
Dynamic Lambda_obj::array( Dynamic it){
	HX_STACK_FRAME("Lambda","array",0x9c8b0512,"Lambda.array","D:\\Programs\\Haxe 3.1.3\\haxe\\std/Lambda.hx",42,0x1cda2409)
	HX_STACK_ARG(it,"it")
	HX_STACK_LINE(43)
...
bool Lambda_obj::has( Dynamic it,Dynamic elt){
	HX_STACK_FRAME("Lambda","has",0x3d8bd693,"Lambda.has","D:\\Programs\\Haxe 3.1.3\\haxe\\std/Lambda.hx",98,0x1cda2409)
	HX_STACK_ARG(it,"it")
