...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",24,0x65056bcc)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(24)
...
Dynamic Std_obj::instance( Dynamic value,::Class c){
	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",28,0x65056bcc)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_FRAME("Std","string",0xcf48855c,"Std.string","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",32,0x65056bcc)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(32)
	if (((s == null()))){
		HX_STACK_LINE(32)
...
int Std_obj::_int( Float x){
	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",36,0x65056bcc)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(36)
	return ::__int__(x);
}
...
Dynamic Std_obj::parseInt( ::String x){
	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",40,0x65056bcc)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(40)
...
Float Std_obj::parseFloat( ::String x){
	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",44,0x65056bcc)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(44)
...
int Std_obj::random( int x){
	HX_STACK_FRAME("Std","random",0x75a77e8e,"Std.random","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Std.hx",47,0x65056bcc)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(48)
	if (((x <= (int)0))){
		HX_STACK_LINE(48)
