...
HX_STACK_FRAME("Xml","__init__",0xbec8a6e7,"Xml.__init__","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",403,0x6249df18)
{
	HX_STACK_LINE(404)
...
::String Xml_obj::get_nodeName( ){
	HX_STACK_FRAME("Xml","get_nodeName",0x38fd668d,"Xml.get_nodeName","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",168,0x6249df18)
	HX_STACK_THIS(this)
	HX_STACK_LINE(169)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",197,0x6249df18)
	HX_STACK_THIS(this)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",238,0x6249df18)
	HX_STACK_THIS(this)
	HX_STACK_LINE(239)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",242,0x6249df18)
			{
				...
				bool run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",244,0x6249df18)
				...
				::Xml run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/Xml.hx",255,0x6249df18)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
