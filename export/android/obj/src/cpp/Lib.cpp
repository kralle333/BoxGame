...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	HX_STACK_FRAME("cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",33,0x4c830113)
...
Dynamic Lib_obj::loadLazy( ::String lib,::String prim,int nargs){
	HX_STACK_FRAME("cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",48,0x4c830113)
	HX_STACK_ARG(lib,"lib")
	HX_STACK_ARG(prim,"prim")
	HX_STACK_ARG(nargs,"nargs")
	HX_STACK_LINE(49)
			...
			Dynamic e = __e;{
				...
				switch( (int)(nargs)){
					case (int)0: {
						...
						Void run(){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",53,0x4c830113)
							{
								HX_STACK_LINE(53)
					...
					case (int)2: {
						...
						Void run(Dynamic _1,Dynamic _2){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",54,0x4c830113)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							{
								HX_STACK_LINE(54)
					...
					case (int)3: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",55,0x4c830113)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							{
					...
					case (int)4: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",56,0x4c830113)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							HX_STACK_ARG(_4,"_4")
					...
					case (int)5: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4,Dynamic _5){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",57,0x4c830113)
							HX_STACK_ARG(_1,"_1")
							HX_STACK_ARG(_2,"_2")
							HX_STACK_ARG(_3,"_3")
							HX_STACK_ARG(_4,"_4")
					...
					default: {
						...
						HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Dynamic,e1)
						Void run(Dynamic _1){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/Lib.hx",58,0x4c830113)
							HX_STACK_ARG(_1,"_1")
							{
								HX_STACK_LINE(58)
								HX_STACK_DO_THROW(e1->__GetItem((int)0));
