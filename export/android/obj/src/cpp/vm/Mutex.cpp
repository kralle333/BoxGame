...
{
HX_STACK_FRAME("cpp.vm.Mutex","new",0xabb3ca05,"cpp.vm.Mutex.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Mutex.hx",27,0x7383a33d)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Mutex.hx",31,0x7383a33d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Mutex.hx",37,0x7383a33d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
