...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Thread.hx",31,0x0ed875d6)
HX_STACK_THIS(this)
HX_STACK_ARG(h,"h")
{
	HX_STACK_LINE(31)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Thread.hx",45,0x0ed875d6)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/vm/Thread.hx",52,0x0ed875d6)
