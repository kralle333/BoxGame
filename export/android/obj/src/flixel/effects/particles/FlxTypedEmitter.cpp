...
Dynamic FlxTypedEmitter_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"blend") ) { blend=inValue.Cast< ::openfl::display::BlendMode >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::BlendMode*/ ,(int)offsetof(FlxTypedEmitter_obj,blend),HX_CSTRING("blend")},
