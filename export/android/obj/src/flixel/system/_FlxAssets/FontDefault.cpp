...
Void FontDefault_obj::__construct(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
{
...
hx::ObjectPtr< FontDefault_obj > FontDefault_obj::__new(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
