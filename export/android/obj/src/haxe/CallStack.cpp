...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_FRAME("haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/CallStack.hx",170,0xfdb8762f)
...
{
		HX_STACK_FRAME("haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/CallStack.hx",180,0xfdb8762f)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(180)
