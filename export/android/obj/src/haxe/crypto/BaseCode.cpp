...
{
HX_STACK_FRAME("haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/crypto/BaseCode.hx",33,0x9fafc78d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/crypto/BaseCode.hx",72,0x9fafc78d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
...
::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/crypto/BaseCode.hx",81,0x9fafc78d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(85)
...
::String BaseCode_obj::decodeString( ::String s){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeString",0x5b4e456a,"haxe.crypto.BaseCode.decodeString","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/crypto/BaseCode.hx",119,0x9fafc78d)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(123)
...
::String BaseCode_obj::decode( ::String s,::String base){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decode",0xc13b97b9,"haxe.crypto.BaseCode.decode","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/crypto/BaseCode.hx",132,0x9fafc78d)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(base,"base")
	HX_STACK_LINE(133)
