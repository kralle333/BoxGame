...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/io/Input.hx",37,0xbb4b0122)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/io/Input.hx",67,0xbb4b0122)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","D:\\Programs\\Haxe 3.1.3\\haxe\\std/haxe/io/Input.hx",127,0xbb4b0122)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
