...
{
HX_STACK_FRAME("haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",29,0x5b6a9716)
HX_STACK_THIS(this)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",34,0x5b6a9716)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",37,0x5b6a9716)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(38)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",42,0x5b6a9716)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	HX_STACK_FRAME("haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Compress.hx",45,0x5b6a9716)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(level,"level")
	HX_STACK_LINE(46)
