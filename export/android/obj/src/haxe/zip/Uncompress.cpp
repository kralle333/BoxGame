...
{
HX_STACK_FRAME("haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",28,0x2ef0afdd)
HX_STACK_THIS(this)
...
Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",33,0x2ef0afdd)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",36,0x2ef0afdd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",41,0x2ef0afdd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
...
::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src,Dynamic bufsize){
	HX_STACK_FRAME("haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","D:\\Programs\\Haxe 3.1.3\\haxe\\std/cpp/_std/haxe/zip/Uncompress.hx",44,0x2ef0afdd)
	HX_STACK_ARG(src,"src")
