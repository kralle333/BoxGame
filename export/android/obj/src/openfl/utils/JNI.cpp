...
Void JNI_obj::init( ){
{
		...
		if ((!(::openfl::utils::JNI_obj::initialized))){
			...
			HX_STACK_LINE(157)
			Dynamic method = ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_init_callback"),(int)1);		HX_STACK_VAR(method,"method");
			HX_STACK_LINE(158)
...
void JNI_obj::__boot()
{
	...
	initialized= false;
	lime_jni_create_field= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_create_field"),(int)4);
	lime_jni_create_method= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_create_method"),(int)5);
	lime_jni_get_env= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_get_env"),(int)0);
	lime_jni_call_member= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_call_member"),(int)3);
	lime_jni_call_static= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_call_static"),(int)2);
}
