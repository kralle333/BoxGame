...
{
	lime_jni_get_member= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_get_member"),(int)2);
	lime_jni_set_member= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_set_member"),(int)3);
}
