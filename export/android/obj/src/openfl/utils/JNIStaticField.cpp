...
{
	lime_jni_get_static= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_get_static"),(int)1);
	lime_jni_set_static= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_jni_set_static"),(int)2);
}
