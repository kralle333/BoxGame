...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/images/particles.png");
		loadSound("assets/music/kick.wav");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/music/snare.wav");
		loadSound("assets/sounds/Blip_Select1.wav");
		loadSound("assets/sounds/Blip_Select2.wav");
		loadSound("assets/sounds/Blip_Select3.wav");
		loadSound("assets/sounds/Blip_Select4.wav");
		loadSound("assets/sounds/Laser_Shoot1.wav");
		loadSound("assets/sounds/Laser_Shoot2.wav");
		loadSound("assets/sounds/Laser_Shoot3.wav");
		loadSound("assets/sounds/Laser_Shoot4.wav");
		loadSound("assets/sounds/Pickup_Coin1.wav");
		loadSound("assets/sounds/Pickup_Coin2.wav");
		loadSound("assets/sounds/Pickup_Coin3.wav");
		loadSound("assets/sounds/Pickup_Coin4.wav");
