...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("assets/images/particles.png", IMAGE);
		add("assets/music/kick.wav", SOUND);
		add("assets/music/music-goes-here.txt", TEXT);
		add("assets/music/snare.wav", SOUND);
		add("assets/sounds/Blip_Select1.wav", SOUND);
		add("assets/sounds/Blip_Select2.wav", SOUND);
		add("assets/sounds/Blip_Select3.wav", SOUND);
		add("assets/sounds/Blip_Select4.wav", SOUND);
		add("assets/sounds/Laser_Shoot1.wav", SOUND);
		add("assets/sounds/Laser_Shoot2.wav", SOUND);
		add("assets/sounds/Laser_Shoot3.wav", SOUND);
		add("assets/sounds/Laser_Shoot4.wav", SOUND);
		add("assets/sounds/Pickup_Coin1.wav", SOUND);
		add("assets/sounds/Pickup_Coin2.wav", SOUND);
		add("assets/sounds/Pickup_Coin3.wav", SOUND);
		add("assets/sounds/Pickup_Coin4.wav", SOUND);
